              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    ...
                    behavioral questions. Your answers will be more structured
                    and impactful. Aim for 60% to pass.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex gap-3 p-3 sm:p-4 bg-blue-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 mt-0.5">
                      Quantify achievements with numbers. Instead of "made it
                      faster," say "reduced processing time by 40%."
                    </p>
                  </div>
                </div>
                ...
                {!isPassed && (
                  <div className="flex gap-3 p-3 sm:p-4 bg-amber-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 mt-0.5">
                        Focus on understanding key technical concepts. Practice

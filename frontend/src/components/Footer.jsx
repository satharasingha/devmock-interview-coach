    ...
    <footer className="mt-24 border-t border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex flex-col md:flex-row items-center justify-between text-sm">
        ...
        <div className="flex items-center gap-2 sm:gap-3 mb-4 md:mb-0 group">
          <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-blue-600 to-cyan-600 dark:from-blue-500 dark:to-cyan-500 rounded-lg flex items-center justify-center text-white font-bold shadow-md group-hover:scale-105 transition-transform duration-300">
            &lt;/&gt;
          </div>
        ...
        <div className="flex items-center gap-3 mt-4 md:mt-0">
          <a 
            href="#" 
            className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 flex items-center justify-center transition-all duration-300 hover:scale-110"
            aria-label="Twitter"
          >
      ...
      <div className="text-center text-[10px] sm:text-xs text-gray-500 dark:text-gray-500 pb-6 sm:pb-8">
        © 2025 DevMock. All rights reserved.
      </div>

...
const testGroq = async () => {
  ...
  const userAnswer = "Object-oriented programming is a programming paradigm that uses objects and classes to organize code.";
  const referenceAnswer = "OOP is a paradigm based on objects containing data and methods.";
